...
export class ReleasesRepository {
  ...
  createRelease(input: {
    ...
    return transaction(this.db, () => {
      ...
      this.db
        .prepare(
          'INSERT INTO releases(id,workspace_id,agent_id,draft_version,config_json,plugins_json,selections_json,provider_bindings_json,mcp_tools_json,created_at,created_by) VALUES(?,?,?,?,?,?,?,?,?,?,?)',
        )
        .run(
          id,
          input.workspaceId,
