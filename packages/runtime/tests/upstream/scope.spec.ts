...
import { bindScopeParent, carrierKeyOf, createScope, isScopeCarrier, scopeChainOf, scopeOf, scopeParentOf, scopeTarget } from '../../src/upstream/scope.ts'
import type { Scope, Scoped } from '../../src/upstream/scope.ts'
