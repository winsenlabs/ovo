...
export function HandoffRequestPanel({
  ...
  calls: CallSummary[];
  targetKind: 'phone' | 'queue';
  setTargetKind: Dispatch<SetStateAction<'phone' | 'queue'>>;
  fallbackKind: 'resume' | 'end' | 'human';
  setFallbackKind: Dispatch<SetStateAction<'resume' | 'end' | 'human'>>;
