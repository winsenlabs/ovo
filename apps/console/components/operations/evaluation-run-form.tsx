...
export function EvaluationRunForm({ datasets, runDatasetId, setRunDatasetId, agents, agentId, setAgentId, releases, releaseId, setReleaseId, executorKind, setExecutorKind, role, providerAvailability, maxAttempts, setMaxAttempts, providerAuthorizationId, setProviderAuthorizationId, matchingAuthorizations, busy, createRun }: {
  datasets: EvaluationDataset[]; runDatasetId: string; setRunDatasetId: Dispatch<SetStateAction<string>>;
  agents: AgentDraft[]; agentId: string; setAgentId: Dispatch<SetStateAction<string>>;
  releases: Release[]; releaseId: string; setReleaseId: Dispatch<SetStateAction<string>>;
  executorKind: 'fixture' | 'provider'; setExecutorKind: Dispatch<SetStateAction<'fixture' | 'provider'>>;
  role: SessionIdentity['role']; providerAvailability: ProviderEvaluationAvailability;
  maxAttempts: number; setMaxAttempts: Dispatch<SetStateAction<number>>;
  providerAuthorizationId: string; setProviderAuthorizationId: Dispatch<SetStateAction<string>>;
  matchingAuthorizations: ProviderEvaluationAuthorization[];
  busy: boolean; createRun: (event: FormEvent<HTMLFormElement>) => Promise<void>;
}) {
  return (
