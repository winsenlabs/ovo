      ...
      <div className="panel-body">
        <label className="toggle-row">
          ...
          <span>
            ...
            <small>
              Carrier/legal preconditions and artifact state are validated outside AgentConfig and
              are not yet exposed by this API.
            </small>
          </span>
        </label>
        <div className="muted">
          Greeting, closing, transfer, DTMF, silence and retention controls are not in the current
          AgentConfig contract. The console does not invent settings for them.
        </div>
      </div>
    </Panel>
  );
