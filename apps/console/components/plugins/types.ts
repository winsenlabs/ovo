...
export type PluginOption = {
  ...
  configSchema?: JsonShape;
  bindingSchema?: JsonShape;
  secretFields?: string[];
  ...
  ui?: {
    ...
    description?: string;
    vendor?: string;
    fields?: Record<string, { widget?: string; label?: string; help?: string; advanced?: boolean }>;
  };
};
...
export const SLOT_KIND: Record<Slot, string> = {
  engine: 'engine',
  carrier: 'carrier',
  stt: 'stt',
  tts: 'tts',
